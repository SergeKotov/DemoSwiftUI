...
enum CourseData {
    ...
    static let quizData = [
            ...
            "05": [CourseQuestion(text: "Имеет ли Swift фреймворк от Apple для рисования графиков и диаграмм?", correct: [0, 1], answers: ["Swift Charts", "Charts", "Graphics", "SwiftData"]),
                   ...
                   CourseQuestion(text: "Для использования фрагментных шейдеров предназначен модификатор...", correct: [0, 1], answers: [".colorEffect", ".layerEffect", ".distortionEffect", ".shaderEffect", ".metalEffect"]),
